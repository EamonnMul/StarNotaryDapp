...
it('can add the star name and star symbol properly', async() => {
    ...
    let instance = await StarNotary.deployed();
    let starId = 6;
    await instance.createStar('Tatooine', starId, {from: accounts[0]});
    assert.equal(await instance.name(), "Starry Night Token");
...
it('lets 2 users exchange stars', async() => {
    ...
    let starId1 = 7;
    let starId2 = 8;
    await instance.createStar('Coruscant', starId1, {from: accounts[0]});
    await instance.createStar('Hoth', starId2, {from: accounts[1]});
...
it('lets a user transfer a star', async() => {
    ...
    let instance = await StarNotary.deployed();
    let starId = 9;
    await instance.createStar('Naboo', starId, {from: accounts[0]});
